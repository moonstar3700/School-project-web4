...
const RelationForm: React.FC<RelationFormProps> = ({ relation, onClose, handleSubmit }) => {
    ...
    const onSubmit = (event: any) => {
        ...
        handleSubmit(subjectInput, sentence, objectInput, typeInput, isUnique);
    };
    return (
        <form className="fixed w-1/3 bg-white divide-y shadow-sm left-1/3 top-1/4 divide-gray-900/10 ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                                ...
                                <div className="flex items-center justify-center h-5">
                                    ...
                                    >
                                        ...
                                        <span
                                            aria-hidden="true"
                                            className={classNames(
                                                isUnique ? 'translate-x-5' : 'translate-x-0',
