...
const mapToEmployee = ({ employee_id, name, role, password, email }: employeePrisma): Employee =>
    new Employee(employee_id, role, name, password, email);
...
const mapToEmployeeArt = ({
    ...
    new Employee(employee_id, role, name, password, email, mapToArticles(articles));

const mapToEmployees = (employees_prisma: employeePrisma[]): Employee[] =>
    employees_prisma.map(mapToEmployee);

const mapToEmployeesArt = (employees_prisma: employeePrisma[]): Employee[] =>
    employees_prisma.map(mapToEmployeeArt);
