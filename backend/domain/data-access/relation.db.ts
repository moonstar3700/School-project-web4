...
let relations: Relation[] = [
    Relation.create(currentid++, 'joe is the president', 'Joe', 'president', null),
    Relation.create(currentid++, 'he eats cake', 'he', 'cake', null),
    Relation.create(
        currentid++,
        'he eats the cake',
        'He',
        'cake',
        Relation_type.create(55, 'makes', false)
    ),
];
...
const getAllRelationsFromArticle = async ({
    article_id,
}: {
    article_id: number;
}): Promise<Relation[]> => {
